...
export class Init1685223856079 implements MigrationInterface {
    name = 'Init1685223856079'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "car_contact" ("carsId" integer NOT NULL, "contactsId" integer NOT NULL, CONSTRAINT "PK_8ba89e4c527939914778878cd6c" PRIMARY KEY ("carsId", "contactsId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "car_contact" ADD CONSTRAINT "FK_1433d1299aa1766ab3e024755b9" FOREIGN KEY ("carsId") REFERENCES "cars"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "car_contact" ADD CONSTRAINT "FK_653e47731a045103c54fa8304c9" FOREIGN KEY ("contactsId") REFERENCES "contacts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
